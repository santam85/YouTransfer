...
exports.config = {
  ...
  onPrepare: function () {
    var defer = q.defer();
    fs.rename(path.join(__dirname, '/../../settings.json'), path.join(__dirname, '/../../settings.json.tmp'), function () {
      defer.resolve();
    });
  ...
  onComplete: function () {
    var defer = q.defer();
    fs.rename(path.join(__dirname, '/../../settings.json.tmp'), path.join(__dirname, '/../../settings.json'), function () {
      defer.resolve();
    });
    return defer.promise;
  }
